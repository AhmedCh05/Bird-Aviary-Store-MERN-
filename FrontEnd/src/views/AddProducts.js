...
function AddProducts() {
  ...
  function handleSubmit(event) {
    ...
    const data = {"title":event.target[0].value,"price":event.target[1].value,"quantity":event.target[2].value,"category":event.target[3].value,"description":event.target[4].value};
